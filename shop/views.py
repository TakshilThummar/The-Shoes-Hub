...
from .models import Blog, FutureProduct, Product, Category
...
def home(request):
    ...
    featured_products = FutureProduct.objects.all()
...
def about(request):
    ...
    return render(request, 'shop/about/about.html')

def contact(request):

    return render(request, 'shop/contact/contact.html')
...
#         super().save(*args, **kwargs)  # Save original first to get file path
